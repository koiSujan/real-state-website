            ...
            <div class="dashboard-container">
                ...
                <section class="overview">
                    <div class="flx flx-ctr flx-between">
                        <h2 class="title-h2">Contacts</h2>
                    </div>
                    <div class="app-content">
                        <?php
                        $rows = array();
                        $statement = $connection->prepare("Select * from contacts order by id desc");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-action">
                                                        ...
                                                        <form id="del-prop-<?php echo $data['id'] ?>" method="post" action="core/delete-contacts.php" style="display:inline">
                                                            ...
                                                            " title="Delete Contact"><i class="ri-delete-bin-line"></i></a>
                                                        </form>
